...
const NavigationMenu = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitive.Root> & { direction?: 'left' | 'right' }
...
const NavigationMenuViewport = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitive.Viewport> & { direction?: 'left' | 'right' }
>(({ className, direction, ...props }, ref) => {

  let directionality = 'left-0 right-auto';
  if (direction === 'right') {
    directionality = 'left-auto right-0'
  } else {
    directionality = 'left-0 right-auto';
  }

  return (
    <div className={cn(directionality, "absolute top-full flex justify-center")}>
