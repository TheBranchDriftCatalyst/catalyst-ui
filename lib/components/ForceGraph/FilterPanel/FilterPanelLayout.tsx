    ...
    <div className="mb-3 pb-3 border-b border-primary/30">
      ...
      <label className="flex items-center gap-2 cursor-pointer group">
        <input
          ...
          className="w-3.5 h-3.5 rounded border-primary/30 bg-background/50 text-primary cursor-pointer transition duration-200 focus:ring-2 focus:ring-primary/30 focus:ring-offset-0"
        />
