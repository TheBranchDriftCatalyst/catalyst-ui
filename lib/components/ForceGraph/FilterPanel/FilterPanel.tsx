...
const FilterPanel: React.FC<FilterPanelProps> = ({ isVisible, onToggle }) => {
  return (
    <>
      ...
      >
        <h3 className="mb-3 text-sm font-bold text-primary tracking-wide uppercase animate-[fade-in_0.3s_ease-out] [animation-delay:0.2s] opacity-0 [animation-fill-mode:forwards]" style={{ textShadow: '0 0 12px var(--primary)' }}>
          Graph Controls
        </h3>
