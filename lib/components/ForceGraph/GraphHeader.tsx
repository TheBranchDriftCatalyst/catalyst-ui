...
const GraphHeader: React.FC<GraphHeaderProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <div className="absolute top-0 left-0 right-0 h-16 bg-background/95 border-b-2 border-primary backdrop-blur-md z-10 flex items-center justify-between px-6 shadow-[0_4px_20px_rgba(var(--primary-rgb),0.2)]">
      {/* Title */}
      <div
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className={`px-4 py-2 text-xs font-semibold transition-all rounded-md ${
            activeTab === 'filters'
