...
export const WithOrphanedNodes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Demonstrates orphaned node filtering. Click the filter icon and try the "🔍 Orphaned" preset or enable the "Show orphaned nodes only" advanced filter to see only nodes with no connections.',
      },
    },
  },
};
...
export const MixedStatusContainers: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Demonstrates status filtering with mixed running and stopped containers. Use the "▶️ Running" preset or the Status Filter dropdown to filter by container status.',
      },
    },
  },
};
...
export const WithInUseResources: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Demonstrates in-use resource filtering. Try the "💾 Show in-use resources only" advanced filter to see only resources currently being used by containers.',
      },
    },
  },
};
...
export const WithSystemResources: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Demonstrates system resource filtering. Enable the "🚫 Hide system resources" advanced filter to hide default Docker networks (bridge, host, none).',
      },
    },
  },
};
...
export const WithSearchFiltering: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Demonstrates search functionality. Try searching for "prod", "staging", "web", or "api" in the filter panel search box to filter nodes by name.',
      },
    },
  },
};
...
export const AllFilteringFeatures: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Comprehensive example demonstrating all filtering features. This graph includes:\n\n" +
...
export const StructuredLayout: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Demonstrates structured layout mode. In the Legend panel (top-left), click "Structured" under the LAYOUT section to see nodes organized by type into columns:\n\n' +
...
export const CompareLayouts: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Use this story to compare force vs structured layouts:\n\n" +
...
export const OrthogonalEdges: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates orthogonal edge routing:\n\n" +
